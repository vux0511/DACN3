                ...
                <div className="row-about">
                    ...
                    <div className="col-2">
                        ...
                        <p className="about-decs">
                            We champion continual progress for athletes and
                            sport by taking action to help athletes reach their
                            potential. Every job at NIKE, Inc. is grounded in a
                            team-first mindset, cultivating a culture of
                            innovation and a shared purpose to leave an enduring
                            impact.
                        </p>
                        <div className="contact">
                            ...
                            <span className="contact-icon-title">
                                <a href="">
                                    {" "}
                                    <GoLocation className="contact-icon" /> 26
                                    Huỳnh Văn Nghệ, Hoà Hải, Ngũ Hành Sơn, ĐN
                                </a>
                            </span>
                            <span className="contact-icon-title">
                                <a href="">
