            ...
            <div className="row">
                ...
                <div className="col-2 margin_top">
                    ...
                    <p className="about-product">
                        The Nike Air Force 1 Shadow puts a playful twist on a
                        classic b-ball design.Using a layered approach, doubling
                        the branding and exaggerating the midsole, it highlights
                        AF-1 DNA with a bold, new look.
                    </p>
                    ...
                    <div className="delivery d1">
                        ...
                        <p>
                            Miễn phí đổi trả hàng khi không hài lòng về sản phẩm
                        </p>
                    </div>
                </div>
            </div>
